	...
	SubShader
	{
		...
		Pass
		{
					...
					)
			{
				...
				float emissiveness121 = packedInput.ase_texcoord3.y;
				float eros67 = packedInput.ase_texcoord3.w;
				float2 texCoord48 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner59 = ( 1.0 * _Time.y * _Noise01UVP + ( texCoord48 * _Noise01UVS ));
				float noiseMultiply51 = packedInput.ase_texcoord3.x;
				float2 texCoord61 = packedInput.ase_texcoord2.xy * float2( 1,1 ) + float2( 0,0 );
				float customOffset50 = packedInput.ase_texcoord2.z;
				...
				float2 temp_cast_1 = (saturate( temp_output_129_0 )).xx;
				float distortionIntensity137 = packedInput.ase_texcoord2.w;
				float2 lerpResult33 = lerp( float2( 0,0 ) , temp_cast_1 , ( _DistortionLerp * distortionIntensity137 ));
				...
				surfaceDescription.Emission = fetchOpaqueVal9.rgb;
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				float2 panner80 = ( 1.0 * _Time.y * _NoiseDistUVP + ( texCoord70 * _NoiseDistUVS ));
				float2 texCoord91 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner103 = ( 1.0 * _Time.y * _Tile02UVP + ( texCoord91 * _TileUVS ));
				float emissiveness121 = packedInput.ase_texcoord4.y;
				float eros67 = packedInput.ase_texcoord4.w;
				float2 texCoord48 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 panner59 = ( 1.0 * _Time.y * _Noise01UVP + ( texCoord48 * _Noise01UVS ));
				float noiseMultiply51 = packedInput.ase_texcoord4.x;
				float2 texCoord61 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float customOffset50 = packedInput.ase_texcoord3.z;
				float lerpResult66 = lerp( _CustomOffsetBase , customOffset50 , _CustomOffsetLerp);
				float smoothstepResult82 = smoothstep( eros67 , ( eros67 + _ErosionSmoothness ) , tex2D( _IntensityMask, ( ( tex2D( _NoiseTexture, panner59 ).r * ( _Noise01Intensity * noiseMultiply51 ) ) + ( ( texCoord61.y * _IntensityMaskUVS ) + lerpResult66 ) ) ).g);
				float temp_output_100_0 = saturate( ( saturate( pow( smoothstepResult82 , _IntensityMaskPower ) ) * _IntensityMaskMultiply ) );
				float temp_output_130_0 = ( ( tex2D( _BaseTexture, ( ( ( ( (UnpackNormalScale( tex2D( _NoiseDistortionTexture, panner80 ), 1.0f )).xy + -0.5 ) * 2.0 ) * _Noise02Intensity ) + panner103 ) ).g * emissiveness121 ) * temp_output_100_0 );
				...
				float temp_output_129_0 = saturate( ( saturate( temp_output_130_0 ) * saturate( ( saturate( ( saturate( ( temp_output_100_0 * tex2D( _OpacityMask, uv_OpacityMask ).g ) ) * distanceDepth111 ) ) * _OpacityMultiply ) ) ) );
				float2 temp_cast_1 = (saturate( temp_output_129_0 )).xx;
				float distortionIntensity137 = packedInput.ase_texcoord3.w;
				float2 lerpResult33 = lerp( float2( 0,0 ) , temp_cast_1 , ( _DistortionLerp * distortionIntensity137 ));
				float4 fetchOpaqueVal9 = ASEHDSampleSceneColor(( appendResult8 + lerpResult33 ).xy, 0.0, GetInverseCurrentExposureMultiplier());
...
Node;AmplifyShaderEditor.Vector2Node;49;-11520,-128;Inherit;False;Property;_Noise01UVS;Noise 01 UV S;3;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;53;-11008,-128;Inherit;False;Property;_Noise01UVP;Noise 01 UV P;5;0;Create;True;0;0;0;False;0;False;0.1,0.3;-0.07,-0.3;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;54;-10240,0;Inherit;False;Property;_Noise01Intensity;Noise 01 Intensity;12;0;Create;True;0;0;0;False;0;False;-1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;55;-8960,128;Inherit;False;Property;_CustomOffsetBase;Custom Offset Base;15;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;56;-8704,256;Inherit;False;Property;_CustomOffsetLerp;Custom Offset Lerp;14;0;Create;True;0;0;0;False;0;False;0;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;60;-10624,-512;Inherit;True;Property;_NoiseTexture;Noise Texture;1;0;Create;True;0;0;0;False;3;Space(33);Header(Noise);Space(13);False;7437ec4c7494cc5409d26f1abc0906eb;7437ec4c7494cc5409d26f1abc0906eb;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.Vector2Node;62;-9216,128;Inherit;False;Property;_IntensityMaskUVS;Intensity Mask UV S;17;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;73;-7424,0;Inherit;False;Property;_ErosionSmoothness;Erosion Smoothness;23;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;71;-11520,1152;Inherit;False;Property;_NoiseDistUVS;Noise Dist UV S;8;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SamplerNode;77;-8192,-256;Inherit;True;Property;_IntensityMask;Intensity Mask;16;0;Create;True;0;0;0;False;3;Space(33);Header(Intensity Mask);Space(13);False;-1;None;504551a45813a5e4ab030aada700596e;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.Vector2Node;76;-11008,1152;Inherit;False;Property;_NoiseDistUVP;Noise Dist UV P;9;0;Create;True;0;0;0;False;0;False;-0.2,-0.1;0.02,-0.1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;79;-7040,-384;Inherit;False;Property;_IntensityMaskPower;Intensity Mask Power;18;0;Create;True;0;0;0;False;0;False;1;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;85;-6528,-384;Inherit;False;Property;_IntensityMaskMultiply;Intensity Mask Multiply;19;0;Create;True;0;0;0;False;0;False;1;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;90;-9728,1664;Inherit;False;Property;_TileUVS;Tile UV S;10;0;Create;True;0;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;96;-9728,1152;Inherit;False;Property;_Noise02Intensity;Noise 02 Intensity;13;0;Create;True;0;0;0;False;0;False;1;0.1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;98;-9088,1664;Inherit;False;Property;_Tile02UVP;Tile 02 UV P;11;0;Create;True;0;0;0;False;0;False;-0.2,-0.1;-0.05,-0.2;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;105;-4736,1792;Inherit;False;Property;_DepthFade;Depth Fade;20;0;Create;True;0;0;0;False;3;Space(33);Header(Depth Fade);Space(13);False;0;0.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;120;-4096,1792;Inherit;False;Property;_OpacityMultiply;Opacity Multiply;21;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;44;-1024,512;Inherit;False;Property;_DistortionLerp;Distortion Lerp;6;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector4Node;12;-2176,1280;Inherit;False;Property;_CutoutMaskSelector;Cutout Mask Selector;4;0;Create;True;0;0;0;False;0;False;0,1,0,0;0,1,0,0;0;5;FLOAT4;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;13;-2304,1024;Inherit;True;Property;_CutoutTexture;Cutout Texture;2;0;Create;True;0;0;0;False;3;Space(33);Header(Cutout);Space(13);False;-1;None;504551a45813a5e4ab030aada700596e;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.RangedFloatNode;3;1024,0;Inherit;False;Property;_Dst;Dst;26;0;Create;True;0;0;0;True;0;False;10;10;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;2;768,0;Inherit;False;Property;_Src;Src;25;0;Create;True;0;0;0;True;0;False;5;5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;4;1280,0;Inherit;False;Property;_ZWrite;ZWrite;27;0;Create;True;0;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;5;1537,0;Inherit;False;Property;_ZTest;ZTest;28;0;Create;True;0;0;0;True;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;1;512,0;Inherit;False;Property;_Cull;Cull;24;0;Create;True;0;0;0;True;3;Space(33);Header(AR);Space(13);False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;151;-384,384;Inherit;False;Constant;_Float1;Float 1;29;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;150;-384,256;Inherit;False;Constant;_Float0;Float 0;29;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;142;0,0;Float;False;True;-1;3;Rendering.HighDefinition.HDUnlitGUI;0;13;Vefects/SH_Vefects_VFX_Easy_Shockwave_Distortion;7f5cb9c3ea6481f469fdd856555439ef;True;Forward Unlit;0;0;Forward Unlit;9;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;True;1;0;True;_SrcBlend;0;True;_DstBlend;1;0;True;_AlphaSrcBlend;0;True;_AlphaDstBlend;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;_CullModeForward;False;False;False;True;True;True;True;True;0;True;_ColorMaskTransparentVel;False;False;False;False;False;True;True;0;True;_StencilRef;255;False;;255;True;_StencilWriteMask;7;False;;3;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;0;True;_ZWrite;True;0;True;_ZTestDepthEqualForOpaque;False;True;1;LightMode=ForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;30;Surface Type;1;638709094304165805;  Rendering Pass ;0;638709104707470335;  Rendering Pass;1;0;  Blending Mode;0;0;  Receive Fog;0;638709094310953111;  Distortion;0;0;    Distortion Mode;0;0;    Distortion Only;1;0;  Depth Write;0;638709094315500503;  Cull Mode;0;0;  Depth Test;4;0;Double-Sided;0;0;Alpha Clipping;0;0;Receive Decals;0;638709094324799208;Motion Vectors;0;638709094327761861;  Add Precomputed Velocity;0;0;Shadow Matte;0;0;Cast Shadows;0;638709094333700251;GPU Instancing;1;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Vertex Position,InvertActionOnDeselection;1;0;LOD CrossFade;0;0;0;8;True;False;True;True;True;False;False;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;143;0,0;Float;False;False;-1;3;Rendering.HighDefinition.HDUnlitGUI;0;1;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;ShadowCaster;0;1;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;_CullMode;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;True;1;LightMode=ShadowCaster;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;144;0,0;Float;False;False;-1;3;Rendering.HighDefinition.HDUnlitGUI;0;1;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;META;0;2;META;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;145;0,0;Float;False;False;-1;3;Rendering.HighDefinition.HDUnlitGUI;0;1;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;SceneSelectionPass;0;3;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;146;0,0;Float;False;False;-1;3;Rendering.HighDefinition.HDUnlitGUI;0;1;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;DepthForwardOnly;0;4;DepthForwardOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;_CullMode;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;True;True;0;True;_StencilRefDepth;255;False;;255;True;_StencilWriteMaskDepth;7;False;;3;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;False;False;True;1;LightMode=DepthForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;147;0,0;Float;False;False;-1;3;Rendering.HighDefinition.HDUnlitGUI;0;1;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;MotionVectors;0;5;MotionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;_CullMode;False;False;False;False;False;False;False;False;False;True;True;0;True;_StencilRefMV;255;False;;255;True;_StencilWriteMaskMV;7;False;;3;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;False;False;True;1;LightMode=MotionVectors;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;148;0,0;Float;False;False;-1;3;Rendering.HighDefinition.HDUnlitGUI;0;1;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;DistortionVectors;0;6;DistortionVectors;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;True;4;1;False;;1;False;;4;1;False;;1;False;;True;1;False;;1;False;;False;False;False;False;False;False;False;False;False;False;False;True;0;True;_CullMode;False;False;False;False;False;False;False;False;False;True;True;0;True;_StencilRefDistortionVec;255;False;;255;True;_StencilWriteMaskDistortionVec;7;False;;3;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;False;True;1;LightMode=DistortionVectors;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;149;0,0;Float;False;False;-1;3;Rendering.HighDefinition.HDUnlitGUI;0;1;New Amplify Shader;7f5cb9c3ea6481f469fdd856555439ef;True;ScenePickingPass;0;7;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;True;7;d3d11;metal;vulkan;xboxone;xboxseries;playstation;switch;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;0;True;_CullMode;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;True;3;False;;False;True;1;LightMode=Picking;False;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
...
WireConnection;142;1;9;0
WireConnection;142;2;151;0
ASEEND*/
//CHKSM=10CFDA36B40B0DE144B1BE1C9C349DFF6B31EB94